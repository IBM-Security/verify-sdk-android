...
[![SDK Version](https://img.shields.io/badge/IBM%20Security%20Verify%20SDK-2.1.4-blue.svg)](https://exchange.xforce.ibmcloud.com/hub/IdentityandAccess)
![Android Version](https://img.shields.io/badge/Android-11-green.svg)
![Android Version](https://img.shields.io/badge/Android%20API-30-green.svg)
...
<table>
  ...
  <tr>
    <td><a href="CHANGELOG.md#security-verify-sdk-214-30062021">v2.1.4</a></td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
| What's supported and what's not | Latest SDK Versions (API 30) | SDK Versions < API 30 |
|-------------------------------------------------------|-----------------|----------------|
